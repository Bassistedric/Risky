...
import SafetyAccidentologyPanel from './SafetyAccidentologyPanel'
...
export default function SafetyDashboardPage(){
 ...
 return <section className="safety-dashboard">
  ...
  {!loading&&!error&&data&&<>
   ...
   <SafetyAccidentologyPanel organizationId={org} year={year} month={month} tradeCode={trade} temporaryWorkers={data.totals.temporary_worker_accidents} subcontractors={data.totals.subcontractor_accidents}/>
